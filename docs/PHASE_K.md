...
- Host tests: **359 passed, 5 ignored** all-features (349 passed, 5 ignored
  default-features; +13 over Phase J Seal 3: the inverse observe/cost/propose/
  frontier unit battery, the inverse-court gates, and the flattening battery);
